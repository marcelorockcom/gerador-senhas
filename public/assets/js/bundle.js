...
function gera() {
  return (0,_gerador__WEBPACK_IMPORTED_MODULE_0__["default"])(qtd.value, maiusculas.checked, minusculas.checked, numero.checked, simbolos.checked);
}
...
var geraSimbolo = function geraSimbolo() {
  return String(simbolos[rand(0, simbolos.length)]);
};
...
(0,_modules_formGeraSenha__WEBPACK_IMPORTED_MODULE_2__["default"])();
